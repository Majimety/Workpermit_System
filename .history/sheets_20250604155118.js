...
async function getSheetData(auth, rowNumber = 2) {
  ...
  console.log("row[37]:", getValue(row, 37));
  console.log("getMatchedValue(row[37]):", getMatchedValue(getValue(row, 37)));

  console.log("SIGNATURE_RECIPIENT URL:", data.SIGNATURE_RECIPIENT);
