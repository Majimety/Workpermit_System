...
async function getSheetData(auth, rowNumber = 2) {
  ...
  // console.log("Base64 length:", SIGNATURE_RECIPIENT.length);
  // console.log("Starts with:", SIGNATURE_RECIPIENT.substring(0, 30));
  // console.log("Ends with:", SIGNATURE_RECIPIENT.slice(-30));
