...
async function deleteOldFileIfExists(authClient, rowNumber) { //ลบไฟล์ PDF เก่าใน Google Drive และลิงก์ URL ที่อยู่ใน Google Sheets
...
async function updateSheetWithUrl(authClient, rowNumber, url) { //เพิ่ม URL ใหม่ลง Sheets
  const sheets = google.sheets({ version: "v4", auth: authClient });
